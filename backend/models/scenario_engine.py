    ...
    *,
    ...
    if scenario.id == "regional-passport":
        return {
            ...
            "assumptions": [
                ...
                "Отсутствующие муниципальные значения отображаются как ограничения,"
                " а не интерполированные факты.",
            ],
            "sources": sources,
        }
    ...
    if scenario.id == "workforce-deficit":
        ...
        return {
            ...
            "recommendations": [
                "Сравнивайте открытые вакансии с аккредитованными программами"
                " перед планированием набора.",
                "Рассматривайте результат как сигнал спроса, поскольку закрытые"
                " данные работодателей исключены.",
            ],
            "sources": sources,
        }
